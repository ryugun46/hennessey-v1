...
export default function MissionSection() {
  return (
    <section className="w-[1440px] h-[804px] bg-hennessey-white pt-[100px] pr-[80px] pb-[100px] pl-[80px] mx-auto mt-[850px] overflow-hidden">
      {/* Top Section */}
      <div className="mb-[10px] relative">
        {/* Our Mission Label - Leftmost */}
        <div className="absolute left-0 flex items-center gap-[10px]">
        ...
        <div className="flex justify-center">
          <div className="max-w-[1280px]">
            <p className="text-hennessey-black text-5xl font-normal mb-[10px]" style={{maxWidth: '1100px', lineHeight: '1.15'}}>
      ...
      <div>
        <div className="flex items-start gap-[10px]">
          ...
          <div className="flex flex-col mx-auto gap-[10px]" style={{width: 'max-content'}}>
            {/* Statistics */}
            <div className="flex items-center" style={{height: 'auto'}}>
